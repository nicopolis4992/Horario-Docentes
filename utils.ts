...
export const MOCK_INITIAL_DATA = {
  ...
  subjects: [
    { id: 's1', name: 'Edición de Video', credits: 3, projectedStudents: 57, area: 'Audiovisual', preferredDays: ['Lunes', 'Miércoles', 'Viernes'] },
    { id: 's2', name: 'Programación I', credits: 4, projectedStudents: 40, area: 'Interactividad' },
    { id: 's3', name: 'Diseño Gráfico I', credits: 2, projectedStudents: 25, area: 'Animación' },
    { id: 's4', name: 'Guionismo', credits: 3, projectedStudents: 30, area: 'Audiovisual' },
    { id: 's5', name: 'Animación 2D', credits: 3, projectedStudents: 20, area: 'Animación' },
    { id: 's6', name: 'Modelado 3D', credits: 4, projectedStudents: 15, area: 'Animación' },
    { id: 's7', name: 'Motores de Videojuegos', credits: 4, projectedStudents: 22, area: 'Interactividad' },
    { id: 's8', name: 'Iluminación', credits: 2, projectedStudents: 18, area: 'Audiovisual' },
    { id: 's9', name: 'Post-producción', credits: 3, projectedStudents: 25, area: 'Audiovisual' },
    { id: 's10', name: 'UX/UI Design', credits: 2, projectedStudents: 35, area: 'Interactividad' },
  ],
  assignments: []
};