        ...
        try {
            if (activeTab === 'docentes') {
                ...
                if (replaceData) {
                    ...
                    newTeachers.forEach(t => dispatch({ type: 'ADD_TEACHER', payload: t }));
                }
                ...
                if (replaceData) {
                    ...
                    newSubjects.forEach(s => dispatch({ type: 'ADD_SUBJECT', payload: s }));
                }
                ...
                if (replaceData) {
                    ...
                    newClassrooms.forEach(c => dispatch({ type: 'ADD_CLASSROOM', payload: c }));
                }
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-end">
                <div>
                    ...
                    <p className="text-slate-500 text-sm mt-1">Carga información desde archivos Excel o CSV.</p>
                </div>
                <button
